	<div style = 'height:100%;position:absolute;left:0px;top:0px;' id = 'mainarea'  class = 'full-width'>
		<div style = 'position:absolute;overflow:hidden;z-index:15;left:0px;width:100%;opacity:0' id = 'imgslide_area'>
            ...
            <img src = "<?php echo base_url(WEB_IMAGES.'Video-play-button.png');?>" style = 'width:8vw; height:8vw;left:50%; margin-left:-4vw; margin-top: 22vw;z-index:11;position:absolute' class = 'playbutton video_play_btn'>
		...
		<div class="video_area">
			<video id="bg_video" controls="controls">
				<source src="<?php echo base_url(WEB_VIDEO.'Ginko_Purple.webm');?>" type="video/webm">
				<source src="<?php echo base_url(WEB_VIDEO.'Ginko_Purple.mp4');?>" type="video/mp4">
				<source src="<?php echo base_url(WEB_VIDEO.'Ginko_Purple.ogv');?>" type="video/ogg">
			</video>
		</div>
		...
		<div style = 'position:relative; background-color:white;min-height:70vw; z-index: 20' id = 'menu_section'>
            ...
            <img src = "<?php echo base_url(WEB_IMAGES.'Arrow 2.png');?>" class = 'arrow' style = 'z-index:10;margin-top:-3vw;top:50%; left:95%; margin-left:-1vw;width:1vw; position:absolute;cursor:pointer' onclick = 'moveToNextImage(1)'>            
           	...
           	<table class='full-width' cols = "*,*,*" style = 'width:100%'>
        		<tr><td colspan = '3' align = 'center' style = 'font-size:4vw;width:100%;padding-top:0;' class = 'cell_title'>Cool Features</td></tr>
                <tr id = 'contentrow1'>
                	<td>
		...
		<div style = 'z-index:30;position:fixed; height:7vw;left:0px;top:0px;' class = 'full-width'>
...
var flag = 0, opacity = 0, opacity1 = 0, currentIndex = 1, moveSlideTimer;
var loadMainPage = function()
{
	$(".loadingpage").animate({opacity:0}, 5000, function() {});
	$("#imgslide_area").animate({opacity:1}, 5000, function() {
		moveSlideTimer = setInterval(function() {moveToNextSlide(1);}, 4000);
